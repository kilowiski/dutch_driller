...
VERBS = [
    # Regular
    {"infinitive": "werken",    "english": "to work",   "type": "regular", "stem": "werk",   "cefr": "A1", "example": "Ik werk vijf dagen per week."},
    {"infinitive": "wonen",     "english": "to live",   "type": "regular", "stem": "woon",   "cefr": "A1", "example": "Wij wonen in een klein dorp."},
    {"infinitive": "leren",     "english": "to learn",  "type": "regular", "stem": "leer",   "cefr": "A1", "example": "Zij leert Nederlands op school."},
    {"infinitive": "spelen",    "english": "to play",   "type": "regular", "stem": "speel",  "cefr": "A1", "example": "De kinderen spelen in de tuin."},
    {"infinitive": "koken",     "english": "to cook",   "type": "regular", "stem": "kook",   "cefr": "A1", "example": "Mijn moeder kookt graag."},
    {"infinitive": "praten",    "english": "to talk",   "type": "regular", "stem": "praat",  "cefr": "A1", "example": "Zij praten over het weer."},
    {"infinitive": "luisteren", "english": "to listen", "type": "regular", "stem": "luister","cefr": "A2", "example": "Ik luister naar muziek."},
    {"infinitive": "fietsen",   "english": "to cycle",  "type": "regular", "stem": "fiets",  "cefr": "A1", "example": "Wij fietsen elke dag naar school."},
    {"infinitive": "reizen",    "english": "to travel", "type": "regular", "stem": "reis",   "cefr": "A2", "example": "Zij reizen graag naar het buitenland."},
    {"infinitive": "dansen",    "english": "to dance",  "type": "regular", "stem": "dans",   "cefr": "A2", "example": "Zij dansen de hele nacht."},
    {"infinitive": "maken",     "english": "to make",   "type": "regular", "stem": "maak",   "cefr": "A1", "example": "Ik maak het ontbijt klaar."},
    {"infinitive": "huren",     "english": "to rent",   "type": "regular", "stem": "huur",   "cefr": "A2", "example": "Wij huren een appartement in de stad."},
    {"infinitive": "bellen",    "english": "to call",   "type": "regular", "stem": "bel",    "cefr": "A2", "example": "Ik bel je morgen terug."},
    {"infinitive": "proberen",  "english": "to try",    "type": "regular", "stem": "probeer","cefr": "A2", "example": "Ik probeer Nederlands te spreken."},
    {"infinitive": "gebruiken", "english": "to use",    "type": "regular", "stem": "gebruik","cefr": "A2", "example": "Zij gebruikt haar telefoon veel."},

    # Irregular
    {"infinitive": "zijn",      "english": "to be",   "type": "irregular", "cefr": "A1", "example": "Ik ben moe vandaag.",
     "irregular": {
    ...
    {"infinitive": "hebben",    "english": "to have", "type": "irregular", "cefr": "A1", "example": "Ik heb een vraag.",
     "irregular": {
    ...
    {"infinitive": "gaan",      "english": "to go",   "type": "irregular", "cefr": "A1", "example": "Ik ga naar huis.",
     "irregular": {
    ...
    {"infinitive": "komen",     "english": "to come",  "type": "irregular", "cefr": "A1", "example": "Zij komt uit Nederland.",
     "irregular": {
    ...
    {"infinitive": "doen",      "english": "to do",    "type": "irregular", "cefr": "A1", "example": "Wat doe je vandaag?",
     "irregular": {
    ...
    {"infinitive": "zien",      "english": "to see",   "type": "irregular", "cefr": "A1", "example": "Ik zie een vogel in de boom.",
     "irregular": {
    ...
    {"infinitive": "eten",      "english": "to eat",   "type": "irregular", "cefr": "A1", "example": "Wij eten om zes uur.",
     "irregular": {
    ...
    {"infinitive": "drinken",   "english": "to drink", "type": "irregular", "cefr": "A1", "example": "Ik drink koffie in de ochtend.",
     "irregular": {
    ...
    {"infinitive": "spreken",   "english": "to speak", "type": "irregular", "cefr": "A1", "example": "Spreekt u Nederlands?",
     "irregular": {
    ...
    {"infinitive": "schrijven", "english": "to write", "type": "irregular", "cefr": "A1", "example": "Ik schrijf een brief.",
     "irregular": {
    ...
    {"infinitive": "lezen",     "english": "to read",  "type": "irregular", "cefr": "A1", "example": "Zij leest een boek.",
     "irregular": {
    ...
    {"infinitive": "lopen",     "english": "to walk",  "type": "irregular", "cefr": "A1", "example": "Ik loop naar de winkel.",
     "irregular": {
    ...
    # Modals
    {"infinitive": "kunnen",    "english": "can / to be able to", "type": "modal", "cefr": "A1", "example": "Ik kan Nederlands spreken.",
     "irregular": {
    ...
    {"infinitive": "moeten",    "english": "must / to have to", "type": "modal", "cefr": "A1", "example": "Ik moet naar school.",
     "irregular": {
    ...
    {"infinitive": "willen",    "english": "to want", "type": "modal", "cefr": "A1", "example": "Ik wil graag een koffie.",
     "irregular": {
